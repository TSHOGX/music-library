        ...
        <>
          <div className="hidden md:flex justify-center items-center">
            <Link to={"/musicians/" + name}>
              <span className="text-gray-500 text-2xl font-medium tracking-wide ease-out duration-200 hover:text-3xl">{name.replace(/_/g, " ")}</span>
            </Link>
          </div>
    
          <div className="hidden md:flex justify-center items-center">
            <hr className="border-t-2 border-gray-400 w-1/3 ml-3 mr-3"/>
            <span className="flex justify-center text-gray-500 font-medium w-1/3 uppercase tracking-wide">{born} - {dead}</span>
            <hr className="border-t-2 border-gray-400 w-1/3 ml-3 mr-3"/>
          </div>
